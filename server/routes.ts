...
// REF: Removed problematic code that was outside registerRoutes function scope
// REF: All route definitions must be inside the registerRoutes function for proper deployment
